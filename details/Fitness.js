    ...
    res.send([
        {
         ...
         "description" : "Kamal Haasan maybe 67 years old, but he never fails to set goals — from acting to fashion and even fitness. As such, the actor’s fitness prowess was captured in a video by director Lokesh Kanagaraj on the sets of his film, Vikram, which went on to break records."
          ...
          {
            "id": "40",
            "title": "‘Losing weight is easy for me, putting it on is hard’: Ranbir Kapoor opens up about his transformation for ‘Shamshera’",
            "Image": "https://images.indianexpress.com/2022/07/ranbir-1200.jpg",
             "category": "Fitness",
            "description": "Dad-to-be Ranbir Kapoor, who is all set to make a comeback after four years with Shamshera, surprised everyone with his rugged look in the film trailer — which is far removed from his otherwise boy-next-door image."
          }
    ])
}
